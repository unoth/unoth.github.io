...
function translateToRussian() {
    ...
    document.querySelector('#about p:nth-of-type(2)').textContent = "Теперь я решила поменять нефтянку на IT, потому что мне всегда были интересны цифровые технологии, и я поняла, что это дейсвитекльно моё. После обучения Android-разработке готова погрузиться в мир программирования.";
